...
**Software Developer | Java, Spring Boot, React, AWS | Full Stack Engineer | Cloud Enthusiast**
...
- 🌐 Skilled in Java, Spring Boot, React, AWS, Docker, Kubernetes, Microservices, SQL
...
**Languages:** Java, Python, JavaScript, C, Golang  
**Frameworks & Libraries:** Spring Boot, Spring MVC, Hibernate, React, React Native, Redux, JUnit, Mockito  
**Web & API Development:** RESTful APIs, JSON, HTML5, CSS3, Axios, Postman  
**Databases:** SQL Server, MySQL, MongoDB, Oracle  
**Cloud & DevOps:** AWS, Azure, Docker, Kubernetes, Jenkins, GitHub Actions  
**Tools & Platforms:** Git, GitHub, Android Studio, Firebase, Swagger
...
[View Project 📅](https://github.com/santoshdannana/AI-Interview-Practice)
